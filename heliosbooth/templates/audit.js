...
&nbsp; &nbsp;&nbsp;
<input type="button" value="post audited ballot to tracking center" onclick="document.getElementById('post_audited_ballot_button').disabled = true; BOOTH.post_audited_ballot();" id="post_audited_ballot_button" class="pretty" style="font-size:0.8em;"/>
