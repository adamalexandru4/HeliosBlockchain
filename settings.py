...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'domnuljohnny@gmail.com')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Adam Alexandru')
...
# google
GOOGLE_CLIENT_ID = get_from_env('GOOGLE_CLIENT_ID', '511198221900-03ciots1vrgd7i0u281n16t0i9bbmek1.apps.googleusercontent.com')
GOOGLE_CLIENT_SECRET = get_from_env('GOOGLE_CLIENT_SECRET', 'DFNwowLJI_B6i6iI9LKyAJPm')
...
def DEPLOY_ADMINISTRATOR_CONTRACT():
    global ADMINISTRATOR_CONTRACT_DEPLOYED, HELIOS_ADMINISTRATOR_CONTRACT_INTERFACE, HELIOS_ADMINISTRATOR_CONTRACT_INSTANCE
    if (not ADMINISTRATOR_CONTRACT_DEPLOYED):
        ...
        ADMINISTRATOR_CONTRACT_DEPLOYED = True
